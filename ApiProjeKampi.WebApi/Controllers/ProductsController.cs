    ...
    public class ProductsController : ControllerBase
    {
        ...
        public IActionResult CreateProduct(Product product)
        {
            ...
            else
            {
                ...
                return Ok("Ürün eklme işlemi başarılı");
            }
        }
        ...
        [HttpGet("ProductWhitCategory")]
        public IActionResult ProductWhitCategory()
        {
            var value = _context.Products.Include(x=>x.Category).ToList();
            return Ok(_mapper.Map<List<ResultProductWhitCategoryDto>>(value));
        }
    }
}
